 ...
 */
public class FileListFragment extends BaseRecyclerListFragment {
    ...
    @Override
    public void init() {
        DB_PATH = Environment.getExternalStorageDirectory().toString() + "/GJ/";
    ...
    private void copyDataBase(String dbName) throws IOException {
        ...
        InputStream myInput = getThisContext().getAssets().open("GJ/"+dbName);
