...
import com.example.answer.adapter.CJExaminationSubmitAdapter;
 ...
 * @author 宫
 */
public class CJAnalogyExaminationActivity extends Activity {
    ...
    CJExaminationSubmitAdapter pagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbManager = new DBManager(CJAnalogyExaminationActivity.this);
        dbManager.openDB();
        initView();
        loadData();
    ...
    public Context getThisContext() {
        return CJAnalogyExaminationActivity.this;
    }
    ...
    private void loadData() {
        ...
        if (!TextUtils.isEmpty(dbPath)) {
            progressDialog = ProgressDialog.show(CJAnalogyExaminationActivity.this, "", "正在读取数据中,请稍候....", true, false);
...
/*   for (int i = 0; i < ConstantData.answerName.length; i++) {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    ...
                    pagerAdapter = new CJExaminationSubmitAdapter(
                            CJAnalogyExaminationActivity.this, viewItems,
                            dataItems, imgServerUrl, dbPath);
    ...
    public void uploadExamination(int errortopicNum) {
        ...
        if (questionInfos.size() > 0) {
            for (int i = 0; i < questionInfos.size(); i++) {
                if (!TextUtils.isEmpty(questionInfos.get(i).getIs_correct()) && questionInfos.get(i).getIs_correct()
                        .equals(ConstantUtil.isCorrect)) {
                    String sScore = questionInfos.get(i).getScore();
                    if (TextUtils.isEmpty(sScore)) sScore = "0";
    ...
    protected void showSubmitDialog() {
        ...
        score.setText(String.format("本次考试得分:%.2f", pageScore));
