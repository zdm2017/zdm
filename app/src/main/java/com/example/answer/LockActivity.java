...
public class LockActivity extends Activity {
        ...
        startBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(TextUtils.isEmpty(code)){
                    Toast.makeText(LockActivity.this,"请重新输入注册码。",Toast.LENGTH_SHORT).show();
                    return;
                }
                String result=getCode(imei);
                if(result.equals(code)){
                    mACache.put(imei+"a","SUCCESS");
                    Intent intent=new Intent(LockActivity.this,FilesActivity.class);
                    startActivity(intent);
                    finish();
                }else{
                    Toast.makeText(LockActivity.this,"密钥验证失败，请重新输入",Toast.LENGTH_SHORT).show();
                }
    ...
    private String getCode(String s){
        return MD5.getMD5(s.getBytes()).substring(2,10);
    }
        ...
        if (!mClipboard.hasPrimaryClip()) {
            ...
            for (int i = 0; i < count; ++i) {
                ...
                CharSequence str = item
                        .coerceToText(LockActivity.this);
